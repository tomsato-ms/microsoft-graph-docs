...
| notificationQueryOptions | string | OData query options for specifying a value for the targeting resource. Clients receive notifications when a resource reaches the state matching the provided query options. Optional. |
